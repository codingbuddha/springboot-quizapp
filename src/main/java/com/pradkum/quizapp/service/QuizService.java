...
import com.pradkum.quizapp.model.Quiz;
import com.pradkum.quizapp.QuizDao;
...
public class QuizService {
    ...
    public ResponseEntity<List<QuestionWrapper>> getQuizQuestions(Integer id) {
        Optional<Quiz> quit = quizDao.findById(id);
        List<Question> questionsFromDB = quit.get().getQuestions();
